...
- Service-worker cache generation is `ppw-shell-v36`. The install shell contains all code, eight sound effects, and five approved sprites; the three large music tracks stream from the same origin on demand so they do not block installation.
