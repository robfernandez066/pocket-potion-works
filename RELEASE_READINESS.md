...
- Service-worker cache generation is `ppw-shell-v33`. The install shell contains all code and eight sound effects; the three large music tracks stream from the same origin on demand so they do not block installation.
