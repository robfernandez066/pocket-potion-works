...
(function exposePocketPotionContent(root, factory) {
  ...
  const CUSTOMER_CONTENT = Object.freeze([
    ...
    Object.freeze({ orderLines: Object.freeze(["Berth marker holds. Good.", "You keep the kettle where it belongs. Sensible.", "I'll come in on the next tide."]), stories: Object.freeze(["After decades at sea, Captain Wren marks the workshop-side berth on his tide chart, then closes the book before anyone can call it a habit; temporary ports taught him not to keep much.", "He returns on the next tide to see whether the blue tarred cord still holds the harbor marker true.", "A small brass route tag stays beside the workshop kettle; Wren says it is easier to find there when he comes back."]) }),
  ...
  const SIGNATURE_COMMISSIONS = Object.freeze([
    ...
    Object.freeze({ id: "wren-harbor", customerId: "customer-7", recipeId: "way", title: "A Safe Harbor", request: "A steady cordial for a ship captain bringing his vessel in after rough water, and one workshop he has begun to mark on the chart.", keepsake: Object.freeze({ mark: "CR", name: "Compass Rose", description: "A worn brass compass rose Wren leaves beside the workshop kettle, so he can find the door again without pretending he forgot it." }) }),
