...
| PWA install/update | Owner check pending | Update an installed `ppw-shell-v46` game to `ppw-shell-v47`, confirm the in-app New update prompt appears, tap it to restart, and verify brewing bubbles appear on the phone without losing progress. Offline relaunch, eviction, and uninstall/reinstall remain separate release checks. |
