...
| Save and rollback compatibility | Pass | Historical v1-v5 migrate to current v6; unsupported future v7 and frozen-v1-v5 downlevel overwrite protection pass. |
...
| PWA install/update | Untested | Install, standalone launch, update from the previous candidate `ppw-shell-v38` to `ppw-shell-v39`, offline relaunch, streamed-music behavior, eviction, uninstall/reinstall. |
