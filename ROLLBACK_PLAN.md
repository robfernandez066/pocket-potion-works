...
- Gameplay save: version `6`, key `pocket-potion-works-v1`; the unchanged key lets v6 migrate v1-v5 and lets frozen downlevel readers protect newer data instead of silently forking it.
- Platform state: `pocket-potion-works-platform-v1`.
- Sound preference: `pocket-potion-works-audio-v1`.
- Current service-worker cache: `ppw-shell-v39`.
