...
const files = ["index.html", "style.css", "game-logic.js", "platform-adapters.js", "app.js", "serve.cjs", "manifest.webmanifest", "service-worker.js", "icon.svg"];
